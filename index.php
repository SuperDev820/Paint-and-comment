  ...
  <div class="container clearfix">
   ...
   <div class="sixteen columns top bottom">
     ...
     <div class="post gallery bottom">
        ...
        <h2 class="title top-2 bottom-2">Sobre Juan<span class="line"></span></h2>
        <!-- Title Post -->
      ...
      <div class="post-content bottom">
        <p>
          ...
          Quisque quis magna vitae ipsum consequat varius in ut ante. Maecenas a mi nibh, eu euismod orci. Vivamus viverra lacus vitae 
          tortor molestie malesuada. In nulla nibh, congue sed molestie nec, dapibus sed purus.
        </p>
        
        <blockquote class="top bottom-2">
          Praesent bibendum lobortis lectus, quis dictum risus faucibus sagittis. Mauris a placerat lacus. Mauris rhoncus dolor sit amet 
          nisl volutpat at consequat tortor feugiat. Ut ornare dui eu ipsum lobortis rhoncus.
        </blockquote>
