...
<head>
  ...
  <!-- Basic Page Needs -->
  <meta charset="utf-8">
  <title>Hablando con Juan Echezarreta Bedia</title>
  ...
  <div class="container clearfix">
   ...
   <div class="eleven columns top bottom">
     ...
     <div class="post gallery bottom">
        ...
        <h2 class="title top-2 bottom-2">Expresen sus ideas y sentimientos en este espacio<span class="line"></span></h2>
        <!-- Title Post -->
        
      
       
     <!--Here goes a random slider from the cuadros table images-->
        ...
        <div class="flex-container">
         <div class="flexslider3">
          <ul class="slides">
            ...
            <li>
            <div class="caption">
            <a href="images/img/blog/post-image-2.jpg" rel="prettyPhoto[]"><img src="images/img/blog/post-image-2.jpg">
            <span class="hover-effect big zoom"></span></a>
            </div><!-- hover effect -->
            </li>
          </ul>
    ...
    <?php
                            include_once ("includes/lateral_derecho.php"); 
							?>
